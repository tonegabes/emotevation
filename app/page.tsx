...
export default function Home() {
  ...
  const handleGenerateQuote = () => {
    ...
    setTimeout(() => {
      ...
      setQuoteHistory(prevHistory => [newQuoteRecord, ...prevHistory].slice(0, 10));
  ...
  const shareQuote = async () => {
    ...
    const shareText = `"${quote}" - Generated by Emotevation for ${name} on ${currentDate}`;
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background dark:bg-[#13151a] relative overflow-hidden">
      <AppNavbar />
